...
![Example Zone with no fly-zone](assets/screenshots/ExampleZone.png)
![Example mission with multiple sub-missions and no-fly-zone detours](assets/screenshots/ExampleMission.png)
